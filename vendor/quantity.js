...
export default class QuantityInput {
    constructor(self, decreaseText, increaseText) {
      ...
      this.add.addEventListener('pointerdown', () => {
            let i = setInterval(()=>this.change_quantity(1), 300);
            this.add.addEventListener('pointerup',()=> this.clear(i),{once:true})
        });
        this.subtract.addEventListener('pointerdown', () => {
                let i = setInterval(()=>this.change_quantity(-1), 300);
                this.subtract.addEventListener('pointerup',()=> this.clear(i),{once:true})
            });
